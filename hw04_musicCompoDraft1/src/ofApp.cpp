...
void ofApp::audioOut(ofSoundBuffer &outBuffer){
    ...
    for(int i = 0; i < outBuffer.size(); i += 2) {
       ...
       lAudio[i]= outBuffer[i] = sample * volume*rightOffset; // writing/drawing to the left channel
       rAudio[i]= outBuffer[i+1] = sample * volume*leftOffset; // writing/drawing to the right channel
